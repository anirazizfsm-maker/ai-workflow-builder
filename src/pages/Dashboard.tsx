    ...
    <div className="relative min-h-screen overflow-hidden dark">
      ...
      <div className="mx-auto max-w-7xl p-4 md:p-6 text-white">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-6 md:mb-8 w-full overflow-x-auto bg-white/10 backdrop-blur-xl border border-white/15 inline-flex items-center md:grid md:grid-cols-5 gap-0 rounded-xl p-0 no-scrollbar h-10">
