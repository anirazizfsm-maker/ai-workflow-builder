...
export default function Landing() {
  ...
  // Mock data for FAQ results
  const faqResults = [
    {
      id: "1",
      question: "How does Lethimdo work?",
      answer: "Lethimdo automates your business workflows by connecting your apps and services. Simply describe your business needs and our AI will create custom workflows to automate repetitive tasks."
    },
    {
      id: "2",
      question: "What apps can I connect?",
      answer: "Lethimdo integrates with 150+ popular business apps including Google Workspace, Slack, Airtable, Notion, Shopify, and more. Our universal connector can work with virtually any API."
    },
    {
      id: "3",
      question: "Is there a free trial?",
      answer: "Yes! Our Free plan includes 5 workflows and 15 days of access. No credit card required to start your trial."
    },
    {
      id: "4",
      question: "How is billing handled?",
      answer: "We offer monthly and annual billing options. All plans include unlimited users and support for multiple integrations."
    }
  ].filter(faq => 
    committedQuery ? 
      faq.question.toLowerCase().includes(committedQuery.toLowerCase()) || 
      faq.answer.toLowerCase().includes(committedQuery.toLowerCase()) : 
      true
  );

  // Mock function for workflow generation
  const generateWorkflowJSON = async (params: { prompt: string }) => {
